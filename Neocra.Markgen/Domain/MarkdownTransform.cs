...
public class MarkdownTransform
{
    ...
    public async Task<string> Transform(string markdown)
    {
        ...
        return await this.RenderHtml(new RenderModelMarkdownPage(new MenuItem("", "", ""), modelMarkdownFile, document.ToHtml(pipeline), "", Array.Empty<HeaderLink>(), false), string.Empty);
    }
